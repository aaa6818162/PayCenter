...
namespace PayCenterSdk.Tool.Rsa
{
    ...
    /// </summary>
    public class PayCenterRSASubmit
    {
        #region 字段
        //支付宝网关地址（新）
        ...
        public PayCenterRSASubmit(string gateway, string private_key, string input_charset, string sign_type)
        {
            _gateway = gateway;
        ...
        private  string BuildRequestMysign(Dictionary<string, string> sPara)
        {
            ...
            string prestr = PayCenteryRSACore.CreateLinkString(sPara);
            ...
            {
                case "RSA":
                    mysign = PayCenterRSA.sign(prestr, _private_key, _input_charset);
                    break;
                default:
                    mysign = "";
                    break;
        ...
        private  Dictionary<string, string> BuildRequestPara(SortedDictionary<string, string> sParaTemp)
        {
            ...
            //过滤签名参数数组
            sPara = PayCenteryRSACore.FilterPara(sParaTemp);
        ...
        private  string BuildRequestParaToString(SortedDictionary<string, string> sParaTemp, Encoding code)
        {
            ...
            string strRequestData = PayCenteryRSACore.CreateLinkStringUrlencode(sPara, code);
