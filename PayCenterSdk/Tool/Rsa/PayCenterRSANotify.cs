...
namespace PayCenterSdk.Tool.Rsa
{
    ...
    /// </summary>
    public class PayCenterRSANotify
    {
        #region 字段
        ...
        public PayCenterRSANotify(string partner, string alipay_public_key, string input_charset, string sign_type)
        {
            //初始化基础配置信息
        ...
        private string GetPreSignStr(SortedDictionary<string, string> inputPara)
        {
            ...
            sPara = PayCenteryRSACore.FilterPara(inputPara);

            //获取待签名字符串
            string preSignStr = PayCenteryRSACore.CreateLinkString(sPara);
        ...
        private bool GetSignVeryfy(SortedDictionary<string, string> inputPara, string sign)
        {
            ...
            if (sign != null && sign != "")
            {
                ...
                {
                    case "RSA":
                        isSgin = PayCenterRSA.verify(preSignStr, sign, alipay_public_key, _input_charset);
                        break;
                    default:
                        break;
                }
