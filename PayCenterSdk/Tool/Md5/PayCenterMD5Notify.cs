...
namespace PayCenterSdk.Tool.Md5
{
    ...
    /// </summary>
    public class PayCenterMD5Notify
    {
        #region 字段
        ...
        public PayCenterMD5Notify(string partner, string key, string input_charset, string sign_type)
        {
            //初始化基础配置信息
        ...
        private string GetPreSignStr(SortedDictionary<string, string> inputPara)
        {
            ...
            sPara = PayCenterMD5Core.FilterPara(inputPara);

            //获取待签名字符串
            string preSignStr = PayCenterMD5Core.CreateLinkString(sPara);
        ...
        private bool GetSignVeryfy(SortedDictionary<string, string> inputPara, string sign)
        {
            ...
            if (sign != null && sign != "")
            {
                ...
                {
                    case "MD5":
                        isSgin = PayCenterMD5.Verify(preSignStr, sign, _key, _input_charset);
                        break;
                    default:
                        break;
                }
