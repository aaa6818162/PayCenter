...
namespace SyncSoft.PayCenterSdk.IOC
{
    public class Container
    {
        private readonly Dictionary<Type, Type> iocMap = new Dictionary<Type, Type>();

        public void Register<TYpetoResolve, TResolvedType>()
        {
