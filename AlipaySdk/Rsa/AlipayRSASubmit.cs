...
namespace AlipaySdk.Rsa
{
    ...
    public class AlipayRsaSubmit
    {
        ...
        public AlipayRsaSubmit(string private_key, string input_charset, string sign_type)
        {
        ...
        private  string BuildRequestMysign(Dictionary<string, string> sPara)
        {
            ...
            string prestr = AlipayRsaCore.CreateLinkString(sPara);
        ...
        private  Dictionary<string, string> BuildRequestPara(SortedDictionary<string, string> sParaTemp)
        {
            ...
            //过滤签名参数数组
            sPara = AlipayRsaCore.FilterPara(sParaTemp);
        ...
        private  string BuildRequestParaToString(SortedDictionary<string, string> sParaTemp, Encoding code)
        {
            ...
            string strRequestData = AlipayRsaCore.CreateLinkStringUrlencode(sPara, code);
        ...
        {
            string url = GATEWAY_NEW + "service=query_timestamp&partner=" + partner + "&_input_charset=" +this._input_charset;
            string encrypt_key = "";
