...
namespace AlipaySdk.Rsa
{
    ...
    public class AlipayRsaNotify
    {
        ...
        public AlipayRsaNotify(string partner, string alipay_public_key, string input_charset, string sign_type)
        {
            //初始化基础配置信息
        ...
        private string GetPreSignStr(SortedDictionary<string, string> inputPara)
        {
            ...
            sPara = AlipayRsaCore.FilterPara(inputPara);

            //获取待签名字符串
            string preSignStr = AlipayRsaCore.CreateLinkString(sPara);
        ...
        private bool GetSignVeryfy(SortedDictionary<string, string> inputPara, string sign)
        {
            ...
            if (sign != null && sign != "")
            {
                ...
                {
                    case "RSA":
                        isSgin = AlipayRsa.verify(preSignStr, sign, alipay_public_key, _input_charset);
                        break;
                    default:
                        break;
                }
