...
namespace AlipaySdk.Md5
{
    ...
    public class AlipayMd5Notify
    {
        ...
        public AlipayMd5Notify(string partner, string key, string input_charset, string sign_type)
        {
            //初始化基础配置信息
        ...
        private string GetPreSignStr(SortedDictionary<string, string> inputPara)
        {
            ...
            sPara = AlipayMd5Core.FilterPara(inputPara);

            //获取待签名字符串
            string preSignStr = AlipayMd5Core.CreateLinkString(sPara);
