...
namespace AlipaySdk.Md5
{
    ...
    public class AlipayMd5Submit
    {
        ...
        public AlipayMd5Submit(string key, string input_charset, string sign_type)
        {
            _key = key.Trim();
        ...
        private  string BuildRequestMysign(Dictionary<string, string> sPara)
        {
            ...
            string prestr = AlipayMd5Core.CreateLinkString(sPara);
        ...
        private  Dictionary<string, string> BuildRequestPara(SortedDictionary<string, string> sParaTemp)
        {
            ...
            //过滤签名参数数组
            sPara = AlipayMd5Core.FilterPara(sParaTemp);
        ...
        private  string BuildRequestParaToString(SortedDictionary<string, string> sParaTemp, Encoding code)
        {
            ...
            string strRequestData = AlipayMd5Core.CreateLinkStringUrlencode(sPara, code);
