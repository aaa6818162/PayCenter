...
{
    /// <summary>
    /// AOP API: alipay.acquire.create
    /// </summary>
    public class AlipayAcquireCreateRequest : IAopRequest<AlipayAcquireCreateResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// 用于商户的特定业务信息的传递，只有商户与支付宝约定了传递此参数且约定了参数含义，此参数才有效。  比如可传递二维码支付场景下的门店ID、门店类型、品牌ID等信息，以json格式传输。
        /// </summary>
