...
{
    /// <summary>
    /// AlipayAcquireCreateResponse.
    /// </summary>
    public class AlipayAcquireCreateResponse : AopResponse
    {
        /// <summary>
        /// 对返回响应码进行原因说明.  result_code响应码为SUCCESS时，不返回该参数
        /// </summary>
        ...
        /// <summary>
        /// 下单处理结果响应码。  SUCCESS：下单成功  FAIL：下单失败  UNKNOWN：结果未知
        /// </summary>
